        ...
        foreach ($dataList as $row) {
            Car::updateOrInsert(
                ...
                [
                    ...
                    'maker_kana' => $row[7],
                    'model' => $row[8],
                    'turningradius' => $row[9] == '' ? NULL : $row[9],
                    'drive' => $row[10] == '' ? NULL : $row[10],
                    'size_length' => $row[11] == '' ? NULL : $row[11],
                    'size_width' => $row[12] == '' ? NULL : $row[12],
                    'size_height' => $row[13] == '' ? NULL : $row[13],
                    'door' => $row[14] == '' ? NULL : $row[14],
                    'wheelbase' => $row[15] == '' ? NULL : $row[15],
                    'mission' => $row[16] == '' ? NULL : $row[16],
                    'tred' => $row[17] == '' ? NULL : $row[17],
                    'shift' => $row[18] == '' ? NULL : $row[18],
                    'indoorsize_length' => $row[19] == '' ? NULL : $row[19],
                    'indoorsize_width' => $row[20] == '' ? NULL : $row[20],
                    'indoorsize_height' => $row[21] == '' ? NULL : $row[21],
                    'fourws' => $row[22] == '' ? NULL : $row[22],
                    'weight' => $row[23] == '' ? NULL : $row[23],
                    'seats' => $row[24] == '' ? NULL : $row[24],
                    'capacity' => $row[25] == '' ? NULL : $row[25],
                    'ridingcapacity' => $row[26] == '' ? NULL : $row[26],
                    'grossweight' => $row[27] == '' ? NULL : $row[27],
                    'missionposition' => $row[28] == '' ? NULL : $row[28],
                    'groundclearance' => $row[29] == '' ? NULL : $row[29],
                    'manualmode' => $row[30] == '' ? NULL : $row[30],
                    'color' => $row[31] == '' ? NULL : $row[31],
                    'comment' => $row[32] == '' ? NULL : $row[32],
                    'enginemodel' => $row[33] == '' ? NULL : $row[33],
                    'environmentalengine' => $row[34] == '' ? NULL : $row[34],
                    'kinds' => $row[35] == '' ? NULL : $row[35],
                    'fuel' => $row[36] == '' ? NULL : $row[36],
                    'supercharger' => $row[37] == '' ? NULL : $row[37],
                    'fueltank' => $row[38] == '' ? NULL : $row[38],
                    'cylinderdevice' => $row[39] == '' ? NULL : $row[39],
                    'JC08' => $row[40] == '' ? NULL : $row[40],
                    'displacement' => $row[41] == '' ? NULL : $row[41],
                    'WLTC' => $row[42] == '' ? NULL : $row[42],
                    'achievedfuel' => $row[43] == '' ? NULL : $row[43],
                    'ps' => $row[44] == '' ? NULL : $row[44],
                    'torque' => $row[45] == '' ? NULL : $row[45],
                    'position' => $row[46] == '' ? NULL : $row[46],
                    'steeringgear' => $row[47] == '' ? NULL : $row[47],
                    'powersteering' => $row[48] == '' ? NULL : $row[48],
                    'VGS' => $row[49] == '' ? NULL : $row[49],
                    'suspension_front' => $row[50] == '' ? NULL : $row[50],
                    'suspension_rear' => $row[51] == '' ? NULL : $row[51],
                    'tiresize_front' => $row[52] == '' ? NULL : $row[52],
                    'tiresize_rear' => $row[53] == '' ? NULL : $row[53],
                    'raketype_front' => $row[54] == '' ? NULL : $row[54],
                    'braketype_rear' => $row[55] == '' ? NULL : $row[55],
                    'year' => $row[56] == '' ? NULL : $row[56],
                    'half' => $row[57] == '' ? NULL : $row[57],
                    'minivan_flug' => $row[58] == '' ? NULL : $row[58],
                    'minivan_style' => $row[59] == '' ? NULL : $row[59],
                    'minivan_3rd' => $row[60] == '' ? NULL : $row[60],
                    'puchivan_flug' => $row[61] == '' ? NULL : $row[61],
                    'puchivan_doorsize' => $row[62] == '' ? NULL : $row[62],
                    'suv_flug' => $row[63] == '' ? NULL : $row[63],
                    'suv_style' => $row[64] == '' ? NULL : $row[64],
                    'hatchback_flug' => $row[65] == '' ? NULL : $row[65],
                    'sedan_flug' => $row[66] == '' ? NULL : $row[66],
                    'wagon_flug' => $row[67] == '' ? NULL : $row[67],
                    'wagon_luggage' => $row[68] == '' ? NULL : $row[68],
                    'sports_flug' => $row[69] == '' ? NULL : $row[69],
                    'kei_flug' => $row[70] == '' ? NULL : $row[70],
                    'kei_style' => $row[71] == '' ? NULL : $row[71],
                    'japan_flug' => $row[72] == '' ? NULL : $row[72],
                    'import_flug' => $row[73] == '' ? NULL : $row[73],
                    'slidedoor_flug' => $row[74] == '' ? NULL : $row[74],
                    'open_flug' => $row[75] == '' ? NULL : $row[75],
                    'mt_flug' => $row[76] == '' ? NULL : $row[76],
                    'van_flug' => $row[77] == '' ? NULL : $row[77],
                    'truck_flug' => $row[78] == '' ? NULL : $row[78],
                    'diesel_flug' => $row[79] == '' ? NULL : $row[79],
                    'hev_flug' => $row[80] == '' ? NULL : $row[80],
                    'ev_flug' => $row[81] == '' ? NULL : $row[81],
                    'oem_flug' => $row[82] == '' ? NULL : $row[82],
                    'suv3rd_flug' => $row[83] == '' ? NULL : $row[83],
                    'headlight_flug' => $row[84] == '' ? NULL : $row[84],
                ]
            );
            $count++;
        }
