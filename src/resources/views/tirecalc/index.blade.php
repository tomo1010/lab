<x-app-layout>
            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg p-6">
                ...
                <form action="{{ route('tirecalc.createPdf') }}" method="POST">
                            ...
                            <div class="relative mb-3">
                                ...
                                <div class="absolute top-0 right-0 flex items-center">
                                    ...
                                    <label class="ml-2 relative inline-block w-[44px] h-[24px]">
                                        <input type="checkbox" class="peer sr-only" id="isItemTaxIncluded1" onchange="test(1)" />
                        ...
                        <div class="bg-blue-50 p-5 rounded-lg shadow-md">
                            <div class="relative mb-3">
                                ...
                                <div class="absolute top-0 right-0 flex items-center">
                                    <p>税込</p>
                                    <label class="ml-2 relative inline-block w-[44px] h-[24px]">
                                        <input type="checkbox" class="peer sr-only" id="isItemTaxIncluded2" onchange="test(2)"  />
                                        <div class="w-full h-full rounded-full bg-gray-300 peer-checked:bg-[#35c759] transition-colors duration-300"></div>
                                        <div class="absolute top-[2px] left-[2px] w-[20px] h-[20px] rounded-full bg-white shadow-[0_4px_10px_-2px_rgba(0,0,0,0.3)] transition-transform duration-300 peer-checked:translate-x-[20px]"></div>
                                    </label>
                                </div>
                        ...
                        <div class="bg-yellow-50 p-5 rounded-lg shadow-md">
                            <div class="relative mb-3">
                                ...
                                <div class="absolute top-0 right-0 flex items-center">
                                    <p>税込</p>
                                    <label class="ml-2 relative inline-block w-[44px] h-[24px]">
                                        <input type="checkbox" class="peer sr-only" id="isItemTaxIncluded3" onchange="test(3)" />
                                        <div class="w-full h-full rounded-full bg-gray-300 peer-checked:bg-[#35c759] transition-colors duration-300"></div>
                                        <div class="absolute top-[2px] left-[2px] w-[20px] h-[20px] rounded-full bg-white shadow-[0_4px_10px_-2px_rgba(0,0,0,0.3)] transition-transform duration-300 peer-checked:translate-x-[20px]"></div>
                                    </label>
                                </div>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-1">
                        ...
                        <div id="tab-content" class="bg-gray-50 p-5 rounded-b-lg shadow-md relative">
                            <h2 id="tab-title" class="text-xl font-bold text-gray-800 border-b pb-2 mb-4">商品1工賃その他設定</h2>
                            <!-- 右端に配置 -->
                            <div class="absolute top-4 right-8 flex items-center">
                                <p>税込</p>
                                <label class="ml-2 relative inline-block w-[44px] h-[24px]">
                                <input type="checkbox" class="peer sr-only" id="isSettingTaxIncluded" onchange="test()" />
                                <div class="w-full h-full rounded-full bg-gray-300 peer-checked:bg-[#35c759] transition-colors duration-300"></div>
                                <div class="absolute top-[2px] left-[2px] w-[20px] h-[20px] rounded-full bg-white shadow-[0_4px_10px_-2px_rgba(0,0,0,0.3)] transition-transform duration-300 peer-checked:translate-x-[20px]"></div>
                                </label>
                            </div>
    ...
    <script>
        ...
        const test = (index) => {
            const id = `isItemTaxIncluded${index}`;
            const isItemTaxIncluded3 = document.getElementById(id).checked;
            console.log('test');
            console.log(isItemTaxIncluded3);
        ...
        function calculateProduct(productNumber) {
            ...
            // 税込か税抜きかのチェックボックスを取得
            const id = `isItemTaxIncluded${index}`;
            const isTaxIncluded = document.getElementById(id).checked;
