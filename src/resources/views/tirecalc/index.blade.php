                        ...
                        <div x-data="taxCalculator()" class="max-w-2xl p-6 bg-white rounded shadow space-y-8">
                            ...
                            <div class="p-4 border rounded space-y-4">
                                ...
                                <div>
                                    ...
                                    <p class="font-bold text-lg">
                                        合計（工賃含む）：<span x-text="totalWithLabor(item1).toLocaleString()"></span> 円
                                    </p>
                                </div>
                            </div>
                            ...
                            <div class="p-4 border rounded space-y-4">
                                ...
                                <div>
                                    ...
                                    <!-- 商品 2 合計 -->
                                    <p class="font-bold text-lg">
                                        合計（工賃含む）：<span x-text="totalWithLabor(item2).toLocaleString()"></span> 円
                                    </p>
                                </div>
                            </div>
                        ...
                        function taxCalculator() {
                            return {
                                ...
                                displayUnitPrice(item) {
                                    const base = this.applyGrossMargin(item.cost);
                                ...
                                totalWithLabor(item) {
                                    return this.totalPrice(item) + this.laborSubtotal;
                                }
                            }
                        }
                    </script>
