...
<!-- ポップアップウィンドウ（重量税月割表） -->
    ...
    <tr>
        ...
        <th class="border px-2 py-1" colspan='5'>3年自家用（新車新規登録）</th>
    </tr>
    <tr>
        <th class="border px-2 py-1" colspan='2'>エコカー</th>
        <th class="border px-2 py-1" colspan='2'>エコカー（本則税率から軽減）</th>
        <th class="border px-2 py-1">エコカー外</th>
    </tr>
    <tr>
        <th class='border px-2 py-1'>免税</th>
    ...
    <tr>
        <td class='border px-2 py-1'>軽</td>
        ...
        <td class="border px-2 py-1"><button onclick="selectTax(3700, 'tax_2')">1800</button></td>
...
<table class='w-full border-collapse'>
    <tr>
        <th class="border px-2 py-1" rowspan='3' class='th2'>車両重量</th>
        <th class="border px-2 py-1" colspan='5'>2年自家用（継続検査、中古車新規登録）</th>
    </tr>
    <tr>
        <th class="border px-2 py-1" colspan='2'>エコカー</th>
    ...
    <tr>
        <th class="border px-2 py-1" class='th1'>免税</th>
        <th class="border px-2 py-1">本則税率</th>
    ...
    <tr>
        ...
        <th class="border px-2 py-1" colspan='6'>新車新規登録</th>
    </tr>
    <tr>
        <th class="border px-2 py-1" colspan='2'>エコカー</th>
    ...
    <tr>
        ...
        <td class="border px-2 py-1"><button onclick="selectTax(6600, 'tax_2')">6600</button></td>
                    ...
                    <table class='w-full border-collapse'>
    <tr>
        <th class="border px-2 py-1" rowspan='2'></th>
        <th class="border px-2 py-1" colspan='2'>エコカー</th>
        <th class="border px-2 py-1" colspan='3'>エコカー外</th>
    </tr>
    <tr>
    ...
    <tr>
        <td class="border px-2 py-1">2年事業用</td>
        <td class="border px-2 py-1"><button onclick="selectTax(0, 'tax_2')">0</button></td>
        <td class="border px-2 py-1"><button onclick="selectTax(5000, 'tax_2')">5000</button></td>
        <td class="border px-2 py-1"><button onclick="selectTax(5200, 'tax_2')">5200</button></td>
        <td class="border px-2 py-1"><button onclick="selectTax(5400, 'tax_2')">5400</button></td>
        <td class="border px-2 py-1"><button onclick="selectTax(5600, 'tax_2')">5600</button></td>
    </tr>
</table>
