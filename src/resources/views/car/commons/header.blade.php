...
@elseif(Request::is('car/puchi*'))
<nav class="navbar navbar-expand-sm navbar-dark" style="background-color:#EF6C70;">
<a class="navbar-brand" href="{{ route('car.category', ['genre'=>$genre]) }}"><img src="https://about-car.net/puchi/wp-content/uploads/tcd-w/logo.png"></a>
