<x-app-layout>
    ...
    <body class="A4">
        <div class="no-print w-full max-w-full md:max-w-4xl mx-auto p-6 bg-white rounded shadow space-y-8 my-12">
            <form method="POST" action="{{ route('label.preview') }}" class="max-w-xl mx-auto space-y-4">
                @csrf
                <div>
                            ...
                            <ul class="mt-6 space-y-4">
                                @foreach ($labels as $label)
                                    <li class="p-4 bg-gray-100 rounded-lg flex justify-between items-center">
                                        <div>
                            <span
                                    class="text-base  font-semibold flex items-center space-x-2"
