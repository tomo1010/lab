...
return new class extends Migration
{
    ...
    public function up()
    {
        Schema::create('quotes', function (Blueprint $table) {
            ...
            //諸費用名称
            $table->integer('overheadName_11')->default(0); 
            $table->integer('overheadName_12')->default(0);
            $table->integer('overheadName_13')->default(0);
            $table->integer('overheadName_14')->default(0);
            $table->integer('overheadName_15')->default(0);
            //非課税　諸費用
